...
//
package org.mashupbots.socko.bootstrap.rest
...
object RestApp extends Logger {
  ...
  val actorSystem = ActorSystem("RestExampleActorSystem")
  ...
  val restRegistry = RestRegistry("org.mashupbots.socko.bootstrap.rest",
